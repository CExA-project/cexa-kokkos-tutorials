    ...
    \begin{columns}
        \begin{column}{0.4\linewidth}
            \begin{itemize}
                ...
                \item Complex core architecture and instruction sets
                \item Versatility
                \item SIMD model
            \end{itemize}
        \end{column}
        \begin{column}{0.4\linewidth}
            \begin{itemize}
                \item 1000s of threads
                \item Simple threads
                \item Specialized for intensive arithmetic computations
                \item SIMT model
            \end{itemize}
        \end{column}
    \end{columns}
...
\begin{frame}{Kokkos programming model}
    Kokkos is a performance portability parallel programming model build upon the C++-20 standard, designed to abstract already existing parallel programming models
...
\begin{frame}{Kokkos: a tool for both C++ beginners and experts}
    \begin{itemize}
        ...
        \begin{itemize}
            \item Profiling, tuning and debugging tools
...
\begin{frame}{Kokkos governance}
    \begin{columns}
        ...
        \begin{column}{0.55\linewidth}
            \begin{itemize}
                \item Kokkos is a project of the High Performance Software Foundation (HPSF, part of the Linux Foundation)
...
\begin{frame}{Where are a View data stored? CPU version}
    ...
    \begin{itemize}
        ...
        \item View comes with metadata (number of dimensions, size, etc.) and data
...
\begin{frame}{More about views}
    \begin{itemize}
        ...
        \pause
        \item Copy construction and assignment are shallow: you pass Views by value, not by pointer (e.g. C arrays); you can still pass by reference
    \end{itemize}
\end{frame}
