    ...
    \begin{columns}
        \begin{column}{0.4\linewidth}
            \begin{itemize}
                ...
                \item All CMake options are available \doclink{\href{https://kokkos.org/kokkos-core-wiki/keywords.html}{on the doc}}
            \end{itemize}
        \end{column}
        \begin{column}{0.6\linewidth}
            \begin{center}
        ...
        \begin{column}{0.5\linewidth}
            \begin{block}{Goal of this exercise}
                \begin{itemize}
                    ...
                    \item Observe the difference between \texttt{create\_mirror} and \texttt{create\_mirror\_view}
                \end{itemize}
            \end{block}
        \end{column}
    \end{columns}
