...
\begin{frame}[fragile]{Creating a View}
    \begin{columns}
        \begin{column}{0.6\linewidth}
            \begin{minted}{C++}
                Kokkos::View<float*>
                    view1("dynamic size", n);

                Kokkos::View<int[100]>
                    view2("static size");

                Kokkos::View<double*[10]>
                    view3("static and dynamic size", n);

                Kokkos::View<double***[10]>
                    view4("four dimensions",
                          width, height, depth);

                Kokkos::View<double[10][10][10]>
                    view5("three statics dimensions");
            \end{minted}
        \end{column}
        \begin{column}{0.4\linewidth}
          \only<1> {
    ...
    \begin{columns}
        ...
        \begin{column}{0.4\linewidth}
            \begin{itemize}
                ...
                \item Raw data can be accessed using the \texttt{data()} method. This is useful when interfacing with third party libraries but should be avoided otherwise
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}[fragile]{Copy and assignation}
    \begin{columns}
        ...
        \end{column}
        \begin{column}{0.4\linewidth}
          \includegraphics[width=1\textwidth]{shallow_copy1.png}
        \end{column}
    \end{columns}
\end{frame}
% _____________________________________________________________________________
...
\begin{frame}[fragile]{Copy and assignation}
    \begin{columns}
        ...
        \end{column}
        \begin{column}{0.4\linewidth}
          \includegraphics[width=1\textwidth]{shallow_copy2.png}
        \end{column}
    \end{columns}
\end{frame}
% _____________________________________________________________________________
...
\begin{frame}[fragile]{Copy and assignation}
    \begin{columns}
        ...
        \end{column}
        \begin{column}{0.4\linewidth}
          \includegraphics[width=1\textwidth]{shallow_copy3.png}
        \end{column}
    \end{columns}
\end{frame}
