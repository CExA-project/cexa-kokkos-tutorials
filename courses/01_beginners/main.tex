...
\begin{frame}[fragile]{Kokkos' abstracted data container}
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Safety, through runtime or compile time checks
        \end{itemize}
...
\begin{frame}[fragile]{Creating a View}
    \begin{columns}
        ...
        \begin{column}{0.4\linewidth}
            \begin{itemize}
                \item Name (usefull for debugging!)
    ...
    \begin{columns}
        ...
        \begin{column}{0.4\linewidth}
            \begin{itemize}
                ...
                \item \texttt{create\_mirror} allocates the memory but it doesn't copy the data!
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}
        ...
        \begin{column}{0.4\linewidth}
            \begin{itemize}
                ...
                \item Views must be similar (shape, layout, etc.)
