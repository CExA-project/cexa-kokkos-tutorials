...
\begin{frame}[fragile]{Copy and assignation}
    \begin{columns}
        ...
        \end{column}
        \begin{column}{0.5\linewidth}
            \only<1 | handout: 0>{\includegraphics[width=\textwidth]{shallow_copy1.png}}
            \only<2 | handout: 0>{\includegraphics[width=\textwidth]{shallow_copy2.png}}
            \only<3- | handout: 1>{\includegraphics[width=\textwidth]{shallow_copy3.png}}
        \end{column}
    \end{columns}
\end{frame}
