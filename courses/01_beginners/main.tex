    ...
    \begin{columns}
        ...
        \begin{column}{0.5\linewidth}
            \begin{itemize}
                ...
                \item Beginners usually do not set the memory space (we'll see why)
                \item Using a backend-specific memory space is possible, but breaks portability
            \end{itemize}
        \end{column}
    \end{columns}
\end{frame}
