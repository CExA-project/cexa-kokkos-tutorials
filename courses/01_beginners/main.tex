...
\begin{frame}[fragile]{Min and index reduction example}
    \begin{itemize}
        \item Pay attention the type of the intermediate and the global results
        \item In this case, Kokkos::ValLocScalar<Scalar, Index>: contains val and loc
    ...
    \begin{minted}{C++}
        ...
        Kokkos::parallel_reduce(
            "MinLocReduce", N,
            KOKKOS_LAMBDA (const int i, minloc_type& local_minloc_value) {
