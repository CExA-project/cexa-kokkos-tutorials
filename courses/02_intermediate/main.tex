...
\begin{frame}[fragile]{Atomic operation}
    \begin{columns}
        \begin{column}{0.55\linewidth}
          \texttt{atomic\_add} execute the \texttt{Write}, \texttt{Read} and \texttt{Add} in a single atomic step,
...
\begin{frame}[fragile]{Performances}
  ...
  For some of your needs, more performant alternative exist, like \texttt{parallel\_reduce}.
\end{frame}
