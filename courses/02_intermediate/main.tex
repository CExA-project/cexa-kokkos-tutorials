...
\begin{frame}[fragile]{What is vectorization}
    \begin{itemize}
        ...
        \item These are usually C functions provided by the compiler
    ...
    \begin{itemize}
        ...
        \item Load the values from memory
            ...
            \begin{minted}{C++}
                ...
                auto x = simd_unchecked_load<simd<double>>(ptr, simd_flag_default);
                auto x = simd_unchecked_load<simd<double>>(ptr, simd_flag_aligned);
            \end{minted}
    \end{itemize}
\end{frame}
    ...
    \begin{minted}{C++}
        ...
        Kokkos::parallel_for("add", N / simd_type::size(),
            KOKKOS_LAMBDA(int i) {
                ...
                simd_type a = Kokkos::Experimental::simd_unchecked_load<simd_type>(&A(idx));
                simd_type b = Kokkos::Experimental::simd_unchecked_load<simd_type>(&B(idx));
                a += b;
...
\begin{frame}[fragile]{Masks}
    \begin{itemize}
        ...
        \item This is the type returned by comparison operations
            ...
            \end{minted}
        \item They can be used in the \texttt{condition} function, or to conditionally load/store elements of a vector
    \end{itemize}
\end{frame}

\begin{frame}[fragile]{Example 2: vectorizing with conditionals}
