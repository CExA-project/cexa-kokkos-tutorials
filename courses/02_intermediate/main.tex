...
\begin{frame}{NVTX connector for NVIDIA tools}
    \begin{itemize}
        ...
        \item Simple connector to convert Kokkos named regions/kernels into NVTX regions for NVIDIA tools
        \begin{itemize}
            \item Nsight Systems
            \item Nsight Compute
        \end{itemize}
    ...
    \begin{columns}
        ...
        \begin{column}{0.4\linewidth}
            \begin{itemize}
                ...
                \item Run only for few iterations
                \item Export environment variable to use the tool
                \item Run the program as usual
                \item Open the generated report
            \end{itemize}
