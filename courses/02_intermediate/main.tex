    ...
    \begin{columns}
        ...
        \begin{column}{0.45\linewidth}
            ...
            \begin{tblr}{colspec={cccc},rowspec={Q[lightmain]Q[white]Q[thread1]Q[thread1]Q[thread1]Q[white]Q[thread6]Q[thread6]Q[thread6]Q[white]}}
                ...
                add 1 & &  & 0 \\
                write value & & $\rightarrow$ & 1 \\
                & & & 1 \\
                & read value & $\leftarrow$ & 1 \\
                & add 6 &  & 1 \\
                & write value & $\rightarrow$ & 7 \\
                & & & 7 \\
            \end{tblr}
        \end{column}
    \end{columns}
    ...
    \begin{columns}
        ...
        \begin{column}{0.45\linewidth}
            ...
            \begin{tblr}{colspec={cccc},rowspec={Q[lightmain]Q[white]Q[thread1]Q[thread6]}}
                Thread 1 & Thread 6 &  & Result \\
                & & & 0 \\
                atomic add & & $\leftrightarrow$ & 1 \\
                & atomic add & $\leftrightarrow$ & 7 \\
                &  &  & 7 \\
            \end{tblr}
            \pause
            \vspace{0.5em}
